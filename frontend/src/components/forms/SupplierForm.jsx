...
export function SupplierForm({ onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      success('Sucesso!', 'Fornecedor cadastrado com sucesso');
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
        <Input name="nome" label="Nome / Razão Social" placeholder="Fazenda Vinicius" value={formData.nome} onChange={handleChange} error={fieldErrors.nome} required className="md:col-span-2" />
        ...
        <Input name="cidade" label="Cidade" placeholder="Jataí" value={formData.cidade} onChange={handleChange} error={fieldErrors.cidade} />
