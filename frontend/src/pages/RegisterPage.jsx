      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col px-16 max-w-xl">
          ...
          <h2 className="text-4xl font-bold leading-tight mb-6 text-[#EDEDEF]">
            Comece agora,<br />
            <span className="text-[#5E6AD2]">é gratuito.</span>
          </h2>

          <div className="space-y-4 mt-4">
            {features.map((feat, i) => (
              <div key={i} className="flex items-center gap-3">
                <div className="flex-shrink-0 w-7 h-7 rounded-lg bg-[#5E6AD2]/15 border border-[#5E6AD2]/25 flex items-center justify-center">
                  <Check className="h-3.5 w-3.5 text-[#5E6AD2]" />
                </div>
                <span className="text-sm text-[#8A8F98]">{feat}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-[#0a0a0c] rounded-2xl border border-white/[0.08] p-8 shadow-[0_24px_64px_rgba(0,0,0,0.5)]">
            <div className="mb-6">
              ...
              <p className="text-sm text-[#8A8F98] mt-1">Preencha os dados abaixo</p>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-[#8A8F98]">
                Já tem uma conta?{' '}
                <button onClick={onToggle} className="text-[#5E6AD2] hover:text-[#6872D9] font-medium transition-colors">
                  Entrar
                </button>
              </p>
            </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-xs text-[#8A8F98]/50">© 2026 FrotaPro</p>
          </div>
        </div>
      </div>
    </div>
